...
## 11.2 Filesystem read-only (reduce impacto si comprometen el contenedor)
...
## 11.3 Reducir capabilities (principio de mínimo privilegio)
...
## 11.4 Limitar recursos (mitiga DoS accidental)
